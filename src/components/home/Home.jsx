...
const Home = () => {
  return (
    <div className="">
        ...
        <div className="hero-content text-center">
          <div className="">
            ...
            <p className="py-6 text-white">
              ...
              next level. From smart devices to the <br /> coolest accessories,
              we have it all!
            </p>
            <button className="btn text-[#9538e2] rounded-3xl font-bold ">
              Shop Now
            </button>
          </div>
        </div>
      ...
      <h1 className="text-2xl md:text-4xl mt-18 mb-14 text-black font-bold items-center justify-center flex ">
